...
def test_auto_deploy_skips_when_only_runtime_state_values_change(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "f8pystudio.ui.mainwin.main_window_state_mixin.compile_runtime_graphs_from_studio",
        lambda _graph: compiled,
    )
...
def test_studio_runtime_sync_updates_local_runtime_without_remote_deploy(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "f8pystudio.ui.mainwin.main_window_runtime_mixin.compile_runtime_graphs_from_studio",
        lambda _graph: compiled,
    )

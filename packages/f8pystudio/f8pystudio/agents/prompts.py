        ...
        blocks.append(
            "\n".join(
                [
                    ...
                    "- Available action tools: `graph_preview_patch`, `graph_apply_patch`, `graph_build_from_goal`, `graph_debug_service`, `graph_auto_layout`, `graph_fix_container_bindings`, `runtime_deploy`, `runtime_service_deploy`, `runtime_set_service_active`, `runtime_set_managed_active`, `runtime_service_process`, `runtime_write_state`, `runtime_sample_port`, `runtime_invoke_command`.",
                    ...
                    "- Use `graph_build_from_goal` for supported typed workflows such as a PyEngine 1 Hz sine wave mapped to 0-100.",

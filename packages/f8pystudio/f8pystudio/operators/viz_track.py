        ...
        F8OperatorSpec(
            ...
            stateFields=[
                ...
                F8StateSpec(
                    name="videoKey",
                    label="Video Key",
                    description="Transport-specific video background key.",
                ...
                F8StateSpec(
                    name="flowKey",
                    label="Flow Key",
                    description="Transport-specific dense flow key.",
                    valueSchema=string_schema(default=""),
                    access=F8StateAccess.rw,
                    required=True,
                    showOnNode=True,
